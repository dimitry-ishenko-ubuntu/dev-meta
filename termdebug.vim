...
command -nargs=* -complete=file -bang Debug call s:StartDebug(<bang>0, <f-args>)
command -nargs=+ -complete=file -bang DebugCommand call s:StartDebugCommand(<bang>0, <f-args>)
...
func s:CreateBreakpoint(id, subid, enabled)
  ...
  if index(s:BreakpointSigns, nr) == -1
    ...
    if exists("g:termdebug_config")
      ...
      if has_key(g:termdebug_config, "sign") && label == ""
